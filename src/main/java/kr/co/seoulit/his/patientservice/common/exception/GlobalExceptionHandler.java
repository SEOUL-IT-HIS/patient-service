...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ApiResponse<Void>> handleBusinessException(BusinessException exception) {
    ...
    return ResponseEntity.status(status)
        .body(ApiResponse.of(status.value(), exception.getMessage(), null));
  }
  ...
  public ResponseEntity<ApiResponse<Void>> handleMethodValidationException(
    ...
    return ResponseEntity.status(HttpStatus.BAD_REQUEST)
        .body(ApiResponse.of(HttpStatus.BAD_REQUEST.value(), errorCode.getMessage(), null));
  }
  ...
  public ResponseEntity<ApiResponse<Void>> handleUnreadableRequest(
    ...
    return ResponseEntity.status(HttpStatus.BAD_REQUEST)
        .body(ApiResponse.of(HttpStatus.BAD_REQUEST.value(), "요청 데이터 형식이 올바르지 않습니다.", null));
  }
  ...
  public ResponseEntity<ApiResponse<Void>> handleTypeMismatch(
    ...
    String message =
        String.format(
            "요청값이 올바르지 않습니다. 파라미터: %s, 입력값: %s", exception.getName(), exception.getValue());
  ...
  public ResponseEntity<ApiResponse<Void>> handleNoResourceFound(
    ...
    return ResponseEntity.status(HttpStatus.NOT_FOUND)
        .body(ApiResponse.of(HttpStatus.NOT_FOUND.value(), "요청한 경로를 찾을 수 없습니다.", null));
  }
